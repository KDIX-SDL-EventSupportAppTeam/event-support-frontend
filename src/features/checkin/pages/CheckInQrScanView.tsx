...
const CAMERA_FAILED_MSG = 'カメラを起動できませんでした。下の「コードを入力する」から進めます。'
const OUT_OF_SCOPE_MSG = 'このQRコードは読み取れませんでした。もう一度かざすか、コードを入力してください。'

export function CheckInQrScanView({ onDetected, onManual }: Props) {
